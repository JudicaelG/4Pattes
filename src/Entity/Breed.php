...
class Breed
{
    ...
    #[ORM\OneToMany(targetEntity: Animals::class, mappedBy: 'breed_id')]
    ...
    public function removeAnimal(Animals $animal): static
    {
        if ($this->animals->removeElement($animal)) {
            ...
            if ($animal->getBreedId() === $this) {
                $animal->setBreedId(null);
            }
        }
